...
# 데이터 불러오기
cu_df=pd.read_csv('/data1/CHH/현대모비스/정형데이터/cu_ver1012.csv')

# 데이터 프레임 및 하이퍼 파라미터 
cu_list=[(cu_df, 2, 'relu','tanh', 'tanh', 'relu',30,50,30,30,'adam',0.07,50,20),
(cu_df, 4, 'relu','tanh', 'tanh', 'relu',30,50,30,30,'adam',0.07,50,20),
(cu_df, 7, 'relu','tanh', 'tanh', 'relu',30,50,30,30,'adam',0.07,50,20)]
    # (2,cu_df_word, 256,30, 'relu','relu','sgd'),
    # (4,cu_df_word, 256,30, 'relu','relu','sgd'),
    # (7,cu_df_word, 256,30, 'relu','relu','sgd')]
...
val_mape_list=[]
for change_df, month_s, lstm_1,lstm_2,den_1,den_2, lstm_num1, lstm_num2,  den_num1, den_num2, opti, learning_rate_num, batch_num, nstep in cu_list:
...
# result_save.to_csv('./Result/cu_predict_values.csv',encoding='utf-8-sig',index=False)
cu = result_save.copy()
cu_mape=val_mape_list
# cu_analysis()
print('Done!')